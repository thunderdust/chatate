...
public class PreferenceMap {
	...
	public static PreferenceMap getCurUserPreference(Context ctx) {
	...
	public static PreferenceMap getMyPreference(Context ctx) {
	...
	public boolean isNotifyWhenNews() {
		return pref.getBoolean(NOTIFY_WHEN_NEWS, MyApplication.mCtx
				.getResources().getBoolean(R.bool.defaultNotifyWhenNews));
	}
	...
	boolean getBooleanByResId(int resId) {
		return MyApplication.mCtx.getResources().getBoolean(resId);
	}
