...
import liu.weiran.chatate.ui.activities.book.AnnotationImageViewActivity;
import liu.weiran.chatate.ui.activities.book.AnnotationVideoViewActivity;
import liu.weiran.chatate.util.book.ImageNameGenerator;
...
public class AnnotationFragment extends Fragment {
	...
	protected void updateButtonImage(Button imageButton, String imageName) {
		...
		if (d != null) {
			...
			toImageDisplay.putExtra("path", imageFile.getAbsolutePath());
