...
public class UpdateContentActivity extends BaseActivity {
	...
	public static void goActivityForResult(Activity activity, String fieldName,
			int requestCode) {
	...
	private void init() {
		...
		String editHint = mCtx.getString(R.string.please_input_hint);
		String changeTitle = mCtx.getString(R.string.change_title);
